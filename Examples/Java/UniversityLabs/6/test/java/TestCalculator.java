...
public class TestCalculator {
    ...
    public void TestCommands()
    {
        ...
        Assert.assertEquals(true,calculator.isEmpty());

        Assert.assertEquals(true,calculator.clear());
        Assert.assertEquals(calculator.length(),calculator.insert(12));
        Assert.assertEquals(false,calculator.isEmpty());
        Assert.assertEquals(12,calculator.delete(0));
